...
function onStart() {
  ...
  log('#logs', "Start button pressed. Yeah baby, let's get this thing running");
}
...
function drawEmoji(canvas, img, face) {
  ...
  // <your code here>
  const anchor = face.featurePoints[5];
  ctx.fillText(face.emojis.dominantEmoji, anchor.x - 80, anchor.y - 50);
}
